...
document_retriever = DocumentRetriever(
    api_key="92b54623-277a-43da-971e-076ca127d4bd", 
    index_name='demo11', 
    ...
    try:
        while True:
            ...
            if data.startswith("get_previous_conversation"):
                ...
                # Process the user's message using the DocumentRetriever class
                ...
                # Send combined chunks to the user
                await manager.send_personal_message(combined_chunks, websocket)

                # Generate a summary from the combined chunks
